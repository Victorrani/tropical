...
def download_data():
    ...
    request = {
        ...
        "year": [str(year) for year in range (1980, 2025)], # altere a data aqui
        "month": ["01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11", "12"],
        "time": ["00:00"],
        "data_format": "netcdf",
        "download_format": "unarchived",
        "area": [20, -90, -20, -40] # altere o domínio espacial aqui
    }

    # [str(y) for y in range(1980, 2025)]  # Exemplo: anos de 1980 a 2024
